	...
	<section id="section-one">
        <div class="row d-block pl-phone">
            ...
            <div class="ml-1 text-helper">
                <span class="pt-5">En esta sección podrás encontrar todos los implementos que se han cargado al sistema con la opción de ver la información y sus estadísticas a detalle.</span>
            </div>
            <div class="right-align show-only-desktop">
            ...
            <table class="display table dataTable table-striped table-sm" cellspacing="0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="colum5 colum3-stats">
                            <a class="icon-table pr-2" href=""><i class="fas fa-eye info-title" data-title="Ver más"></i></a>
                            <a class="icon-table" href="infoQR.php"><i class="fas fa-chart-line info-user" data-title="Ver estadisticas"></i></a>
                        </td>
                    </tr>
                </tbody>
                <!-- PREV
