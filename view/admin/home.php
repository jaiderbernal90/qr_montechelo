	...
	<section id="section-one">
        <div class="row d-block pl-phone">
            ...
            <div class="title-second">
                <h5 class="ml-1 mt-5 ">¿Qué quieres hacer hoy?</h5>
            </div>
        </div>
        <div class="row mt-3">
            <div class="card text-right">
             ...
             <div class="card text-left ml mt-2">
                 <div class="header-card">
                      <img src="../../img/undraw_my_app_grf2.png" alt="Generar QR">
                 </div>
                 <div class="content-card">
                     <h3><a href="registerImplements.php"  class="nav-link"> Generar QR</a></h3>
                 </div>
             </div>
        </div>   
	</section> 
