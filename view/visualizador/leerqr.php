	...
	<section id="section-one">
        ...
        <div class="row">
            <form action="" class="form col s12 mt-1">
                ...
                <div class="col s12 center-align mt-1 m-3-phone">
                    <a href="home.php"><button type="button" class="btn btn-actions btn-disabled">Volver</button></a>
                    <a href="leerqrCamera.php"><button type="button" class="btn btn-actions btn-color-secundary">Cámara</button></a>
