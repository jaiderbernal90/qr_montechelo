...
<body>  
    ...
    <div id="img" class="container-fluid mt-5">
            ...
            <div class="row mb-5">
                <div class="col s12">
                    ...
                    <div class="file-upload center-align">
                             <input type="file" name="codeQR" id="codeQR" class="input-file" required accept=".png, .pdf">
                             <label for="codeQR" id="fileName" class="mt-3">Ningun archivo seleccionado</label>
                    </div>
                </div>
            </div>
            <div class="center-align">
                <button type="submit" class="btn btn-actions btn-color-primary mt-1" id="guardar" >Guardar</button>
            </div>
        </form>
    </div>
    
    <div id="paass" class="container-fluid">
        <form class="login100-form validate-form container-fluid mt-5" action="" method="POST">
            ...
            <div class="center-align">
                <button type="submit" id="guardar2" class="btn btn-actions btn-color-primary">
                    <i class=""></i> Guardar
                </button>
            </div>
        </form>
